	...
	return (
		<div className="Login">
			...
			<div className="LoginContents">
				<h1 style={{fontSize:"50px"}}>Spotify Compare</h1>
				<h3>Check out your friends' Spotify playlists and compare them to see what musical tastes you have in common!</h3>
